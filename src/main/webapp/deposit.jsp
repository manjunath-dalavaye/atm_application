    ...
    <div class="rowa">
            ...
            <div class="containera">
                <div class="card-container">
                    ...
                    <div class="front">
                        ...
                        <div class="card-number-box">####-####-####-<%out.print(session.getAttribute("card_no")); %>
                        </div>
                        <div class="flexbox">
                            <div class="box">
        ...
        <div class="features">
            <form action="depositprocess.jsp">
                ...
                <input type="number" placeholder="00000" name="deposit" required  />
                <input type="submit" class="submit" placeholder="Enter"/>
            </form>
        </div>
    </div>
